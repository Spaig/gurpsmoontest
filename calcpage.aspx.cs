        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {//if Standard Ice Worlds
                ...
                {//Standard Ice World generation
                    ...
                    temp.setHydro(genHydro(12, rand));//ice worlds have normal hydrographic coverage (broadly)
                    temp.setSurfaceTemp(genSurfaceTemp(12, roll3D()));//generate surface temperature
                    temp.setBlackBody(genBlackbody(12, temp.getAtmoMass(), temp.getSurfaceTemp(), temp.getHydro()));//set blackbody value with previously generated values -should call special method
                    temp.setEarthsDiameter(calcDiameter(12, rand,
                        diameterMaxFactor(12, temp.getBlackBody(), temp.getEarthDensity()),
                        diameterMinFactor(12, temp.getBlackBody(), temp.getEarthDensity())
                        ));//heckin doozy of a call - calculate diameter by calculating max and min and passing it to main calc method
                    temp.setMilesDiameter(diameterToMiles(temp.getEarthsDiameter()));//call conversion method
                    temp.setSurfaceGravity(calcSurfGrav(temp.getEarthsDiameter(), temp.getEarthDensity()));//call gravity method
                    temp.setMass(calcMass(temp.getEarthDensity(), temp.getEarthsDiameter()));//call mass method
                    temp.setPressure(calcPressure(temp.getAtmoMass(), temp.getSurfaceGravity(), 12));//call pressure method
                    worlds[cursor] = temp;//store World in worlds array
                    cursor++;//increment cursor
                }
            }
            ...
            {//if Large Cthonian World
                ...
                {//Large Cthonian World generation
                    ...
                    temp.setEarthDensity(lgIronCoreDensity(roll3D()));//set density by passing 3D6 into density method - Standard and large worlds have large iron cores
                    temp.setMetricDensity(densityConversion(temp.getEarthDensity()));//call density conversion method on first density value
                    temp.setAtmoMass(0);//Cthonian worlds have no atmosphere
                    temp.setHydro(0);//also no hydrographic coverage
                    temp.setSurfaceTemp(genSurfaceTemp(15, roll3D()));//generate surface temperature
                    temp.setBlackBody(genBlackbody(15, temp.getAtmoMass(), temp.getSurfaceTemp(), temp.getHydro()));//set blackbody value with previously generated values -should call special method
                    temp.setEarthsDiameter(calcDiameter(15, rand,
                        diameterMaxFactor(15, temp.getBlackBody(), temp.getEarthDensity()),
                        diameterMinFactor(15, temp.getBlackBody(), temp.getEarthDensity())
                        ));//heckin doozy of a call - calculate diameter by calculating max and min and passing it to main calc method
                    temp.setMilesDiameter(diameterToMiles(temp.getEarthsDiameter()));//call conversion method
                    temp.setSurfaceGravity(calcSurfGrav(temp.getEarthsDiameter(), temp.getEarthDensity()));//call gravity method
                    temp.setMass(calcMass(temp.getEarthDensity(), temp.getEarthsDiameter()));//call mass method
                    temp.setPressure(calcPressure(temp.getAtmoMass(), temp.getSurfaceGravity(), 15));//call pressure method
                    worlds[cursor] = temp;//store World in worlds array
                    cursor++;//increment cursor
                }
            }
            ...
            {//ifLarge Ocean World
                ...
                {//Large Ocean World  generation
                    ...
                    temp.setMetricDensity(densityConversion(temp.getEarthDensity()));//call density conversion method on first density value
                    temp.setAtmoMass(genAtmo(roll3D()));//normal atmospheres
                    temp.setHydro(genHydro(17, rand));//normal hydrographic call, triggers special ocean world calc
                    temp.setSurfaceTemp(genSurfaceTemp(17, roll3D()));//generate surface temperature
                    temp.setBlackBody(genBlackbody(17, temp.getAtmoMass(), temp.getSurfaceTemp(), temp.getHydro()));//set blackbody value with previously generated values -should call special method
                    temp.setEarthsDiameter(calcDiameter(17, rand,
                        diameterMaxFactor(17, temp.getBlackBody(), temp.getEarthDensity()),
                        diameterMinFactor(17, temp.getBlackBody(), temp.getEarthDensity())
                        ));//heckin doozy of a call - calculate diameter by calculating max and min and passing it to main calc method
                    temp.setMilesDiameter(diameterToMiles(temp.getEarthsDiameter()));//call conversion method
                    temp.setSurfaceGravity(calcSurfGrav(temp.getEarthsDiameter(), temp.getEarthDensity()));//call gravity method
                    temp.setMass(calcMass(temp.getEarthDensity(), temp.getEarthsDiameter()));//call mass method
                    temp.setPressure(calcPressure(temp.getAtmoMass(), temp.getSurfaceGravity(), 17));//call pressure method
                    worlds[cursor] = temp;//store World in worlds array
                    cursor++;//increment cursor
                }
            }
            ...
            {//if Large Ice World
                ...
                {//Large Ice World  generation
                    ...
                    temp.setMetricDensity(densityConversion(temp.getEarthDensity()));//call density conversion method on first density value
                    temp.setAtmoMass(genAtmo(roll3D()));//normal atmospheres
                    temp.setHydro(genHydro(18, rand));//normal hydrographic call, triggers special ocean world calc
                    temp.setSurfaceTemp(genSurfaceTemp(18, roll3D()));//generate surface temperature
                    temp.setBlackBody(genBlackbody(18, temp.getAtmoMass(), temp.getSurfaceTemp(), temp.getHydro()));//set blackbody value with previously generated values -should call special method
                    temp.setEarthsDiameter(calcDiameter(18, rand,
                        diameterMaxFactor(18, temp.getBlackBody(), temp.getEarthDensity()),
                        diameterMinFactor(18, temp.getBlackBody(), temp.getEarthDensity())
                        ));//heckin doozy of a call - calculate diameter by calculating max and min and passing it to main calc method
                    temp.setMilesDiameter(diameterToMiles(temp.getEarthsDiameter()));//call conversion method
                    temp.setSurfaceGravity(calcSurfGrav(temp.getEarthsDiameter(), temp.getEarthDensity()));//call gravity method
                    temp.setMass(calcMass(temp.getEarthDensity(), temp.getEarthsDiameter()));//call mass method
                    temp.setPressure(calcPressure(temp.getAtmoMass(), temp.getSurfaceGravity(), 18));//call pressure method
                    worlds[cursor] = temp;//store World in worlds array
                    cursor++;//increment cursor
                }
            }
